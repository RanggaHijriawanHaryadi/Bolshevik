...
public class player : MonoBehaviour
{
    ...
    void Awake()
    {
        skorteks.text = managerDragon.Instance.skorscene1.ToString();
    }
    public void TambahSkor(int jumlah)
    {
        managerDragon.Instance.skorscene1 += jumlah;
        skorteks.text = managerDragon.Instance.skorscene1.ToString();
    }
    ...
    {
        yield return new WaitForSeconds(pemutarsuara.clip.length);
